...
import { getRoastKey, ROAST_TTL, getDebugKey, DEBUG_TTL } from '../constants';
import { fetchMovieDetails } from '../services/tmdb';
import { getOrCreateMovieTruth } from '../services/perplexity';
...
export async function handleMovieRoast(tmdbId: string, env: Env, correlationId: string) {
	...
	// Step 1: Get or create movie truth from Perplexity (cache-first)
