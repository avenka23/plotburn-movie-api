...
```json
{
  ...
  "roast": {
    ...
    "internet_vibe": [
      "Twitter is losing it over this",
      "Reddit calling it a masterpiece ironically",
      "YouTube reviewers clickbaiting hard"
    ],
    "your_opinion": "Why you should or shouldn't watch",
    "recommendation": [
      "Movie 1 - why it's better",
      "Movie 2 - why it's better",
      "Movie 3 - why it's better",
      "Movie 4 - why it's better"
    ]
  },
...
```json
{
  ...
  "content": "Main satirical content (multiple paragraphs)",
  "internet_vibe": [
    "Twitter hot take about this movie",
    "Reddit thread drama summary",
    "YouTube comment section chaos",
    "Fan vs hater debate point",
    "Viral meme reference"
  ],
  "your_opinion": "Personalized take on whether to watch",
  "recommendation": [
    "Movie 1 - why it's better",
    "Movie 2 - why it's better",
    "Movie 3 - why it's better",
